...
\begin{abstract}
This paper will perform a secondary analysis of Kubernetes CNI performance data, focusing on the CNIs available in Rancher. It aims to make a usage recommendation.
